...
import './style.css' // 하나만 임포트 해둬도 모두 적용
    ...
    return (
        <div id="qna-write-wrapper">
            ...
            <div className='qna-write-contents-box'>
                <textarea ref={contentsRef} className='qna-write-contents-textarea' placeholder='내용을 입력해주세요. / 1000000자' maxLength={1000} value={contents} onChange={onContentsChangeHandler} />
            </div>
        </div>
    );
}
